...
export const missionFixture = 
    ...
    }, 
    {
        ...
        mission_id: "F3364BF",
        "manufacturers": ["Orbital ATK"],
        "payload_ids": ["Iridium NEXT 1", "Iridium NEXT 2", "Iridium NEXT 3", "Iridium NEXT 4", "Iridium NEXT 5", "Iridium NEXT 6", "Iridium NEXT 7", "Iridium NEXT 8"],
...
test("MissionsList renders with missions data", () =>{
    ...
    rerender(<MissionsList error="" missions={missionFixture} />);
